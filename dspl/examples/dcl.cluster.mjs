//deno run -A --v8-flags=--max-old-space-size=8192 ./dspl/runner.mjs ./dspl/examples/novodcl.mjs novodclx6-10r-notest-t0.3-4o-a.json
...
Enclose your code in a markdown codeblock.`,
                    ...
                    {
                        type: "prompt",
                        content: `Carefully review and classify the solutions provided to identify the largest cluster of solutions that are similar to each other.`,
                    },
                    {
                        type: "prompt",
                        n: 5,
                        temperature: 0.8,
                        content: `Solve the programming challenge following the rules and constraints as closely as possible. Produce a solution on the basis of the approach taken in the largest cluster identified above. 
